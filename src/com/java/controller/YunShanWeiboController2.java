...
public class YunShanWeiboController2 {
	...
	Map<String,String> definedImageMap = new HashMap<String,String>();
...
//				List<Event> definedEventList = new ArrayList<Event>();
//				definedEventList.add(mysqlEvent.selectEventByEid("1"));
//				definedEventList.add(mysqlEvent.selectEventByEid("2"));
//				definedEventList.add(mysqlEvent.selectEventByEid("3"));
//				definedEventList.add(mysqlEvent.selectEventByEid("311"));
//				definedEventList.add(mysqlEvent.selectEventByEid("315"));
//				
//				List<String> definedImageList = new ArrayList<String>();
//				definedImageList.add("lindan.png");
//				definedImageList.add("luoyixiao.png");
//				definedImageList.add("luodai.jpg");
//				definedImageList.add("meilianhang.jpg");
//				definedImageList.add("sade.jpg");
				
				eventList = new ArrayList<Event>();
				eventList.add(mysqlEvent.selectEventByEid("1"));
				eventList.add(mysqlEvent.selectEventByEid("2"));
				eventList.add(mysqlEvent.selectEventByEid("3"));
				eventList.add(mysqlEvent.selectEventByEid("311"));
				eventList.add(mysqlEvent.selectEventByEid("315"));
				
				imageList.add("lindan.png");
				imageList.add("luoyixiao.png");
				imageList.add("luodai.jpg");
				imageList.add("meilianhang.jpg");
				imageList.add("sade.jpg");
			}
		}else{
//			eventList = mysqlEvent.getEventInfo();
			eventList = new ArrayList<Event>();
	...
	public String eventDetail(Model model,String eid) throws Exception {
		...
		model.addAttribute("eventImage",definedImageMap.get(eid));
 ...
 */
	public void initImg(){
		definedImageMap.put("1", "lindan.png");
		definedImageMap.put("2", "luoyixiao.png");
		definedImageMap.put("3", "luodai.jpg");
		definedImageMap.put("311", "meilianhang.jpg");
		definedImageMap.put("315", "sade.jpg");
	}
